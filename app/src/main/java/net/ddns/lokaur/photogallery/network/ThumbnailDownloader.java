...
public class ThumbnailDownloader<T> extends HandlerThread {
    ...
    public void setThumbnailDownloaderListener(ThumbnailDownloaderListener<T> TThumbnailDownloaderListener) {
        mThumbnailDownloaderListener = TThumbnailDownloaderListener;
    }
